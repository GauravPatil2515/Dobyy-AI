    ...
    <div className="login-page" style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          AI-powered fabric design. Create beautiful tartans and textiles with natural language.
        </p>
        ...
        <div style={{
          ...
          <ul style={{
            ...
            <li style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              <span style={{ color: '#4ade80' }}>✓</span> Basic weave patterns
            </li>
            <li style={{ display: 'flex', alignItems: 'center', gap: '10px', opacity: '0.5' }}>
              <span>✗</span> WIF export (Pro only)
            </li>
          </ul>
        </div>
        ...
        >
          ...
          {loading ? 'Signing in...' : (isOfflineState ? 'Offline - Sign in unavailable' : 'Continue with Google')}
        </button>
